...
public class BuilderItemTransforms {
   ...
   public BuilderItemTransforms put(TransformType type, ItemTransform transform) {
   ...
   public BuilderItemTransforms putModded(TransformType type, ItemTransform transform) {
      if (this.block_model_builder == null) {
         throw new IllegalStateException("ItemTransformsBuilder already used");
      }
